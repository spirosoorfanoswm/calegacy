...
public class ExportServiceImpl implements ExportService {
    ...
    @Autowired
    ReportTransformatorFactory reportTransformatorFactory;

    @Autowired
    PdfReportBuilderService pdfReportBuilderService;
    ...
    public void exportCustomers(CustomersInputDto input, String user) throws DatabaseConnectionException, IOException {
        ...
        StringBuilder exportFilenamePrefix= ExportUtils.createExportFileNamePrefix(input);
        ...
        notificationService.notify(new Notification(
                StringGenUtils.format(appProperties.getMessages().get(3),
                        new String[]{
                                ...
                                Integer.toString(input.getPortfolioId()),
                                username})), username);
    }
