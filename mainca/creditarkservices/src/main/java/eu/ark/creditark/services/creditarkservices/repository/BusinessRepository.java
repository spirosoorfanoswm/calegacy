...
import eu.ark.creditark.services.creditarkservices.shared.CustomDataMap;
...
import eu.ark.creditark.services.creditarkservices.shared.CustomerIdentity;
import eu.ark.creditark.services.creditarkservices.shared.Portfolio;
import eu.ark.creditark.services.creditarkservices.shared.PortfolioAging;
import eu.ark.creditark.services.creditarkservices.shared.PortfolioAgingOverall;
import eu.ark.creditark.services.creditarkservices.shared.ReportProperties;
import eu.ark.creditark.services.creditarkservices.shared.ScenarioCustomerStatistics;
import eu.ark.creditark.services.creditarkservices.shared.ScenarioDefaultParams;
...
public class BusinessRepository {
	...
	public ConfigInfo getConfigInfo(String loginName) throws DatabaseConnectionException {
		...
		try (Connection conn = jdbcTemplate.getDataSource().getConnection()) {
			...
			logger.error("DB configinfo for " + loginName);
