...
public class TransformatorConfig {
    ...
    @Bean("reportTransformatorFactory")
    public FactoryBean reportTransformatorFactoryBean() {
        ServiceLocatorFactoryBean factoryBean = new ServiceLocatorFactoryBean();
        factoryBean.setServiceLocatorInterface(ReportTransformatorFactory.class);
        return factoryBean;
    }
}
