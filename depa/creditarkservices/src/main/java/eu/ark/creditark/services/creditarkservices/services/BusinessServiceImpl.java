...
public class BusinessServiceImpl implements BusinessService {
	...
	@Autowired
	private ClienteleTransformatorFactory clienteleTransformatorFactory;
	...
	public CustomerListDto customers(CustomersInputDto input) throws DatabaseConnectionException {
		...
		if(input.getScenarioId()>0)
			response.setCustomers(repositoryBucket.getCustomersScenario(input, schema));
		else
	...
	public ClienteleTransformatorFactory getClienteleTransformatorFactory() {
		return clienteleTransformatorFactory;
	}

	public void setClienteleTransformatorFactory(ClienteleTransformatorFactory clienteleTransformatorFactory) {
		this.clienteleTransformatorFactory = clienteleTransformatorFactory;
	}
