...
export class AlertService {
    ...
    loadSpinner(message: string, alertId?: string) {
        this.alert(new Alert({ message, type: AlertType.Load, alertId }));
    }

    unLoadSpinner(message: string, alertId?: string) {
        this.alert(new Alert({ message, type: AlertType.Unload, alertId }));
    }
}